...
<template>
  <div>
    ...
    <div v-if="projectStore.isLoading" class="mt-6 text-center text-gray-500">
      Loading projects...
    </div>
    <div v-else-if="projectStore.error" class="mt-6 p-4 bg-red-100 text-red-700 rounded-lg">
      {{ projectStore.error }}
    </div>
      ...
      <table class="w-full text-sm text-left text-gray-500">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
          <tr>
            ...
            <th scope="col" class="px-6 py-3">Tampil di Hero</th>
          ...
          >
            ...
            <td class="px-6 py-4 text-right">
              <router-link
                ...
                class="font-medium text-brand-accent-gold hover:underline"
                >Edit</router-link
              >
            </td>
          </tr>
