...
<template>
  <div class="min-h-screen flex bg-white">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-12">
      <div class="w-full max-w-md">
        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <div>
            <button type="submit" :disabled="isLoading" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-brand-dark-blue hover:opacity-90 disabled:opacity-70">
    ...
    <!-- Kolom Kanan: Gambar -->
    <div class="hidden lg:block lg:w-1/2 bg-cover bg-center" style="background-image: url('https://images.pexels.com/photos/19038627/pexels-photo-19038627.jpeg');">
    </div>
  </div>
</template>
