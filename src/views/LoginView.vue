        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          <div>
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
              ...
              <input id="email" type="email" required class="block w-full rounded-md border-gray-300 pl-10 focus:border-brand-dark-blue focus:ring-brand-dark-blue" placeholder="Masukkan email" />
            </div>
          </div>
          <div>
            <label for="password" class="block text-sm font-medium text-gray-700">Kata Sandi</label>
             <div class="mt-1 relative rounded-md shadow-sm">
              ...
              <input id="password" type="password" required class="block w-full rounded-md border-gray-300 pl-10 focus:border-brand-dark-blue focus:ring-brand-dark-blue" placeholder="Masukkan kata sandi" />
            </div>
          </div>
          <div>
