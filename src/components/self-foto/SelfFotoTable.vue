      ...
      <table class="w-full text-sm text-left text-gray-500">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
          <tr>
            ...
            <th scope="col" class="px-6 py-3">Biaya/Org Tambahan</th>
            <th scope="col" class="px-6 py-3">Biaya/Menit Tambahan</th>
        ...
        <tbody>
          <tr v-for="pkg in packages" :key="pkg.id" class="bg-white border-b hover:bg-gray-50">
            ...
            <td class="px-6 py-4">{{ formatCurrency(pkg.pricePerExtraPerson) }}</td>
            <td class="px-6 py-4">{{ formatCurrency(pkg.pricePerExtraMinute) }}</td>
